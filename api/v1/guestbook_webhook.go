...
//+kubebuilder:webhook:path=/mutate-cloudstack-iblog-pro-v1-guestbook,mutating=true,failurePolicy=fail,sideEffects=None,groups=cloudstack.iblog.pro,resources=guestbooks,verbs=create;update,versions=v1,name=mguestbook.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-cloudstack-iblog-pro-v1-guestbook,mutating=false,failurePolicy=fail,sideEffects=None,groups=cloudstack.iblog.pro,resources=guestbooks,verbs=create;update,versions=v1,name=vguestbook.kb.io,admissionReviewVersions=v1
